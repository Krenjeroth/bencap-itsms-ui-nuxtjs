...
const handleSubmit = async () => {
  await ticketStore.acceptTicket(props.ticket?.id);
...
<template>
  <BaseModal :on-close="onClose" :title="`Accept ${props.pageTitle}`">
    <div class="space-y-4">
      <!-- Ticket details -->
      <div
      ...
      <p class="text-xs text-gray-500 dark:text-gray-400">
        By accepting, you will be added as personnel in charge for this
        {{ props.pageTitle }}.
        <br />
        If you are the first personnel, the ticket will move to
        <span class="font-semibold">In progress / Accepted</span>. If you later
        un-accept and no other personnel remain, it will return to
        <span class="font-semibold">Queued / Open</span>.
      </p>
